...
export RUN_SUFFIX=${RUN_SUFFIX:-"gemma270_siglip2_libero_10_30epochs_neg300_51bins_$(date +%H%M%S)"}
exec bash "${PROJECT_ROOT}/scripts/value_training/libero/run_value_libero_10_gemma_10epochs.sh"
