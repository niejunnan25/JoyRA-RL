...
cd /mnt/workspace/users/zhangtianle/JoyRA
...
#CKPT_DEFAULT="/mnt/workspace/users/yuanzhihao/code/starVLA/outputs/robocasa_300_epose/checkpoints/steps_100000_pytorch_model.pt"


CKPT_DEFAULT="/mnt/workspace/users/yuanzhihao/code/starVLA/outputs/robocasa_1000_epose_w_state/checkpoints/steps_100000_pytorch_model.pt"

#CKPT_DEFAULT="/mnt/workspace/users/yuanzhihao/code/starVLA/outputs/robocasa_300_epose_w_state/final_model/pytorch_model.pt"
# CKPT_DEFAULT="/mnt/workspace/users/yuanzhihao/code/starVLA/outputs/StarVLA_Qwen3_VL_GR00T_Robocasa_gr1/checkpoints/steps_90000_pytorch_model.pt"
...
temp_dir="/mnt/workspace/users/zhangtianle/JoyRA/outputs"
temp_dir="${temp_dir}/$(basename "${CKPT_PATH}" .pt)"
mkdir -p "${temp_dir}"
LOG_DIR="${temp_dir}/eval_$(date +%Y%m%d_%H%M%S)"
