...
cd /mnt/workspace/users/chenzengjue/starVLA2
...
freeze_module_list='qwen_vl_interface.model.model' # just for fast debug, sota is under fully FT, i.g., freeze_module_list=""
DIT_TYPE="DiT-B"
data_root_dir=/mnt/workspace
data_mix=galaxea_suqian_agi


run_root_dir=/mnt/workspace/users/chenzengjue/starVLA2/res
# run_id=gal_sq_freellm_bs256_pd32_ac50
run_id=gal_sq_freellm_bs256_pd32_ac50_data_25wstep
export WANDB_MODE=offline
export WANDB_DIR=/mnt/workspace/users/chenzengjue/starvla_wandb
...
env IS_TORCHRUN=1 torchrun \
  ...
  --config_yaml /mnt/workspace/users/chenzengjue/starVLA2/examples/galaxea_sq/train_files/starvla_cotrain_gal_sq.yaml \
  ...
  --run_id ${run_id} \
  --wandb_project starVLA_egodex \
  --wandb_entity 1179210529-jilin-university \
