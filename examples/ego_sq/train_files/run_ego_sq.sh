...
env IS_TORCHRUN=1 torchrun \
  ...
  --config_yaml ./examples/ego_sq/train_files/starvla_cotrain_ego_sq.yaml \
  ...
  --run_id ${run_id} \
  --wandb_project #YOUR_WANBD \
  --wandb_entity #YOUR_WANBD\
