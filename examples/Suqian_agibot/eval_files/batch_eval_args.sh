...
CKPT_DEFAULT="/mnt/workspace/users/yuanzhihao/code/starVLA/outputs/debug_starvla_qwen3fast_fourier_gr1_unified_1000/checkpoints/steps_10000_pytorch_model.pt"
