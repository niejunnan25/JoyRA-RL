...
freeze_module_list='qwen_vl_interface.model.model.language_model' #'qwen_vl_interface.model.model' # just for fast debug, sota is under fully FT, i.g., freeze_module_list=""
DIT_TYPE="DiT-B"
data_root_dir=/mnt/workspace/datasets/
data_mix=suqian_train


run_root_dir=./outputs
run_id=pretrain_sq_joint_fre_l
...
LOGFILE=${output_dir}/train_$(date +%Y%m%d_%H%M%S).log
...
env IS_TORCHRUN=1 torchrun \
  ...
  --config_yaml examples/Suqian_agibot/train_files/starvla_cotrain_robocasa_gr1.yaml \
