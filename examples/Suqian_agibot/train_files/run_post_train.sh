...
data_mix=suqian_test_table_clean


run_root_dir=./outputs
run_id=post_sq_table_clean_pre_sq
...
env IS_TORCHRUN=1 torchrun \
  ...
  --trainer.pretrained_checkpoint /mnt/workspace/users/yuanzhihao/code/starVLA/outputs/suqian_pretrain/checkpoints/steps_100000_pytorch_model.pt \
