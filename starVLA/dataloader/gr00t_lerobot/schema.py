...
class DatasetStatisticalValues(BaseModel):
    ...
    def serialize_ndarray(self, v: NDArray) -> Any:
        """Serialize numpy array to list (supports multi-dimensional arrays)"""
...
class DatasetStatistics(BaseModel):
    ...
    relative_action: dict[str, DatasetStatisticalValues] = Field(default_factory=dict, description="Statistics of the relative action")
