...
from starVLA.dataloader.gr00t_lerobot.relative_action_stats.types import (
    ActionConfig,
    ActionFormat,
    ...
    "agibot_genie1": {
        ...
        "state": ModalityConfig(
            ...
            modality_keys=[
                ...
                "right_arm",
                "right_hand",
                "original_state_head_position",
                "original_state_waist_position",
            ],
        ),
        "action": ModalityConfig(
            ...
            modality_keys=[
                ...
                "right_arm",
                "right_hand",
                "original_action_head_position",
                "original_action_waist_position",
            ],
            action_configs=[
                # left_arm
                ActionConfig(
