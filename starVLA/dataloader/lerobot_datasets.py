...
def make_LeRobotSingleDataset(
    ...
    enable_relative_action = data_cfg.get("enable_relative_action", False) if data_cfg else False
    ...
    return LeRobotSingleDataset(
        ...
        data_cfg=data_cfg,
        enable_relative_action=enable_relative_action,
    )
...
if __name__ == "__main__":
    ...
    cfg.datasets.vla_data.data_mix = "suqian_test_chaji"
