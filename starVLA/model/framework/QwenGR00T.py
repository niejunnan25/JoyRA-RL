...
if __name__ == "__main__":
    ...
    parser.add_argument("--config_yaml", type=str, default="/mnt/workspace/users/chenzengjue/starVLA2/examples/Robocasa_tabletop/train_files/starvla_cotrain_ego_sq.yaml", help="Path to YAML config")
    args, clipargs = parser.parse_known_args()

    debugpy.listen(("0.0.0.0", 10093))
    print("🔍 Rank 0 waiting for debugger attach on port 10092...")
    debugpy.wait_for_client()
    args.config_yaml = "/mnt/workspace/users/chenzengjue/starVLA2/examples/Robocasa_tabletop/train_files/test.yaml"
