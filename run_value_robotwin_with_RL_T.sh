...
RUN_SUFFIX=${RUN_SUFFIX:-hplusneg}
...
BIG_NEGATIVE=${BIG_NEGATIVE:-1200}
...
# Batch size is per GPU/rank under DDP. With 8 GPUs, BATCH_SIZE=16 means global batch size 128.
...
echo "GLOBAL_BATCH_SIZE=$((BATCH_SIZE * NUM_GPUS_PER_NODE * ${PET_NNODES:-1}))"
